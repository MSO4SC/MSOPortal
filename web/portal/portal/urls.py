...
urlpatterns = [
    ...
    url(r'^marketplaceNoLogIn/$', views.marketplace_noLogIn,
        name='marketplace_noLogIn'),
    ...
    url(r'^datacatalogueNoLogIn/$', views.datacatalogue_noLogIn,
        name='datacatalogue_noLogIn'),
