...
urlpatterns = [
    ...
    url(r'^_get_infra_list$',
        views.get_infra_list, name='_get_infra_list'),
    url(r'^_add_infra$',
        views.add_infra, name='_add_infra'),
    url(r'^_delete_infra$',
        views.delete_infra, name='_delete_infra'),
    url(r'^_get_computing_list$',
        views.get_computing_list, name='_get_computing_list'),
    url(r'^_add_computing$',
        views.add_computing, name='_add_computing'),
    url(r'^_delete_computing$',
        views.delete_computing, name='_delete_computing'),
    url(r'^_get_inputs$',
        views.get_inputs, name='_get_inputs'),
