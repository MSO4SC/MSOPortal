...
urlpatterns = [
    ...
    url(r'^_get_hpc_infra_list$',
        views.get_hpc_infra_list, name='_get_hpc_infra_list'),
    url(r'^_add_hpc_infra$',
        views.add_hpc_infra, name='_add_hpc_infra'),
    url(r'^_delete_hpc_infra$',
        views.delete_hpc_infra, name='_delete_hpc_infra'),
    url(r'^_get_hpc_list$',
