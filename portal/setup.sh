...
sed -i 's/import urlparse/#import urlparse/g' $1/cloudify_rest_client/aria/*.py
sed -i 's/urlparse\./urllib.parse./g' $1/cloudify_rest_client/aria/*.py
sed -i 's/urllib\.quote/urllib.parse.quote/g' $1/cloudify_rest_client/aria/*.py
